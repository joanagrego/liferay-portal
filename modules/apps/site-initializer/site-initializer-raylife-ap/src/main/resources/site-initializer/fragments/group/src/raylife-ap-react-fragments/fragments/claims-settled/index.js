...
export default function () {
	const [selectedFilterDate, setSelectedFilterDate] = useState('4');
	...
	const chartLoadData = [
		{
			dataColumns: [
				['settled', thisMonthSettledClaims],
				['remaining', totalOfClaimsThisMonth - thisMonthSettledClaims],
			],
		...
		{
			dataColumns: [
				['settled', threeMonthsSettledClaims],
				[
					'remaining',
		...
		{
			dataColumns: [
				['settled', sixMonthsSettledClaims],
				['remaining', totalOfClaimsSixMonths - sixMonthsSettledClaims],
			],
			percentual: getSettledPercentual(
		...
		{
			dataColumns: [
				['settled', yearToDateSettledClaims],
				[
					'remaining',
